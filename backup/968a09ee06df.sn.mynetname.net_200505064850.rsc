...
/ppp profile
set *0 use-upnp=yes
add dns-server=1.0.0.1,8.8.8.8 local-address=192.168.20.1 name="Wi-Fibre PPP" only-one=yes remote-address="PPP Pool Alberton Core (Be IP's)" use-encryption=no
...
add default-profile="Wi-Fibre PPP" disabled=false interface= "ether4-Denton to King PtP" keepalive-timeout=30 service-name= "BeBroadband Wi-Fibre (Denton Core)"
