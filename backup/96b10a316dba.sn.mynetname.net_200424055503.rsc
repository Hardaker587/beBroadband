...
add dns-server=1.0.0.1,8.8.8.8 local-address=192.168.10.1 name="Wi-Fibre PPP" only-one=yes remote-address="PPP Pool Alberton Core (Be IP's)" use-encryption=no
...
add default-profile="Wi-Fibre PPP" disabled=false interface= "ether9 Camberley -> KING (Primary)" keepalive-timeout=120 service-name= "BeBroadband Wi-Fibre (Camberley Core)"
...
add disabled=true name=wifibre063@bebroadband password="W1F1bR300 $" profile= "Wi-Fibre PPP" service=pppoe
