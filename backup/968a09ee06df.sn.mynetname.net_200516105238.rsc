...
set [ find default-name=ether4 ] name="ether4-Denton to King PtP" rx-flow-control=auto tx-flow-control=auto
...
add default-profile="Wi-Fibre PPP" interface="ether4-Denton to King PtP" keepalive-timeout=30 max-mtu=1480 service-name= "BeBroadband Wi-Fibre (Denton Core)"
