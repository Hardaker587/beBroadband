...
add add-default-route=true disabled=false interface=WAN-Bridge keepalive-timeout=60 max-mtu=1480 name=pppoe-out1 password="W1F1bR300 $" user=wifibre092@bebroadband
/interface wireless
