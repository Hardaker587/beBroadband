...
add add-default-route=true disabled=false interface=WAN-Bridge keepalive-timeout=60 max-mtu=1480 name=pppoe-out1 password="W1F1bR300 $" use-peer-dns=true user=wifibre092@bebroadband
/interface wireless
...
add comment="HP Switch at Golden Views" mac-address=70:10:6F:64:F3:51 type= bypassed
add comment="Unifi AP22 at Golden Views" mac-address=74:83:C2:40:BA:E2 type= bypassed
add comment="Unifi AP22 at Golden Views" mac-address=74:83:C2:40:BA:E7 type= bypassed
add comment="Unifi AP1 at Golden Views" mac-address=74:83:C2:40:BA:F7 type= bypassed
add comment="Unifi AP2 at Golden Views" mac-address=E0:63:DA:6A:1C:86 type= bypassed
add comment="Unifi AP3 at Golden Views" mac-address=E0:63:DA:6A:1C:8A type= bypassed
add comment="Unifi AP4 at Golden Views" mac-address=E0:63:DA:6A:1C:93 type= bypassed
add comment="Unifi AP5 at Golden Views" mac-address=E0:63:DA:6A:1C:AC type= bypassed
add comment="Unifi AP6 at Golden Views" mac-address=E0:63:DA:6A:1D:56 type= bypassed
add comment="Unifi AP7 at Golden Views" mac-address=E0:63:DA:6A:1D:64 type= bypassed
add comment="Unifi AP8 at Golden Views" mac-address=E0:63:DA:6A:1D:66 type= bypassed
add comment="Unifi AP9 at Golden Views" mac-address=E0:63:DA:6A:1D:7A type= bypassed
add comment="Unifi AP10 at Golden Views" mac-address=E0:63:DA:6A:1D:87 type= bypassed
add comment="Unifi AP11 at Golden Views" mac-address=E0:63:DA:6A:1D:88 type= bypassed
add comment="Unifi AP12 at Golden Views" mac-address=E0:63:DA:6A:1D:A9 type= bypassed
add comment="Unifi AP13 at Golden Views" mac-address=E0:63:DA:6A:1E:72 type= bypassed
add comment="Unifi AP14 at Golden Views" mac-address=E0:63:DA:6A:1E:8B type= bypassed
add comment="Unifi AP15 at Golden Views" mac-address=E0:63:DA:6A:1E:98 type= bypassed
add comment="Unifi AP16 at Golden Views" mac-address=E0:63:DA:6A:1F:23 type= bypassed
add comment="Unifi AP17 at Golden Views" mac-address=E0:63:DA:6A:1F:26 type= bypassed
add comment="Unifi AP18 at Golden Views" mac-address=E0:63:DA:6A:20:0C type= bypassed
add comment="Unifi AP19 at Golden Views" mac-address=E0:63:DA:6A:20:12 type= bypassed
add comment="Unifi AP20 at Golden Views" mac-address=E0:63:DA:6A:20:49 type= bypassed
add comment="Unifi AP21 at Golden Views" mac-address=E0:63:DA:6A:21:BE type= bypassed
...
add comment="*.ubnt.com UBNT Server 5" dst-host=*.ubnt.com
...
add comment="0.ubnt.pool.ntp.org UBNT Server 1" dst-host= 0.ubnt.pool.ntp.org
add comment="0.ubnt.pool.ntp.org UBNT Server 2" dst-host= 0.ubnt.pool.ntp.org
add comment="d2cnv2pop2xy4v.cloudfront.net UBNT Server 6" dst-host= d2cnv2pop2xy4v.cloudfront.net
add comment="dmuml5c39zuoo.cloudfront.net UBNT Server 7" dst-host= dmuml5c39zuoo.cloudfront.net
add comment="Google DNS1 8.8.8.8" dst-host="Google DNS1"
add comment="Google DNS2 8.8.4.4" dst-host="Google DNS2"
add comment="ns-1758.awsdns-27.co.uk UBNT Server 8" dst-host= ns-1758.awsdns-27.co.uk
add comment="wifiportal.bebroadband.co.za 188.166.66.208" dst-host= wifiportal.bebroadband.co.za
...
add action=accept comment="UBNT Server 3 [Dest:197.80.150.123]" disabled= false dst-address=197.80.150.123
add action=accept comment="UBNT Server 4 [Dest:41.223.244.123]" disabled= false dst-address=41.223.244.123
add action=accept comment="UBNT Server 6 [Dest:54.230.44.163]" disabled=false dst-address=54.230.44.163
