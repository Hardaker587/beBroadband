...
/ip hotspot profile
add dns-name=be.hotspot hotspot-address=10.6.60.1 html-directory= datatill_hotspot1 http-cookie-lifetime=1d login-by= mac,cookie,http-chap,http-pap,trial,mac-cookie name=hotspot1 radius-interim-update=1m trial-uptime-limit=1d use-radius=true
/ip pool
...
set use-radius=true
/radius
add address=178.128.143.98 secret=B3Adm1nCor3!@3 service=ppp,login,hotspot src-address=102.67.156.12 timeout=3s
/radius incoming
